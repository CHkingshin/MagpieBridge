...
@Slf4j
@Service
@Transactional(rollbackFor = Exception.class)//任意错误都回滚
public class JWTServiceImpl implements IJWTService {
    ...
    public String generateToken(String username, String password, int expire)
        ...
        Date expireDate = Date.from(zdt.toInstant());//转为Date对象
        //返回jwt对象
        return Jwts.builder()
                // jwt payload 部分 --> 本质是个KV对象
